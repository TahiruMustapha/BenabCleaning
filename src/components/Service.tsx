  ...
  return (
    <div  id="service" className=" w-full mt-10  md:mt-20 ">
      <div className=" flex flex-col  max-w-[450px] mx-auto  mt-5 items-center justify-between">
        ...
        <div>
          <h4 className="text-blue-600 text-center font-medium text-2xl md:text-3xl capitalize mt-10">
            Over 30+ Years of experience in cleaning service
          </h4>
        </div>
      </div>
      <div className=" w-full md:w-[80%] px-3 mx-auto mt-14 md:mt-32   md:flex items-center md:gap-6  ">
        {serviceData.map((servBox) => (
          <div key={servBox.title} className={ servBox.active == true ?`w-full  px-5 mb-8 hover:border-none shadow-lg duration-200 py-4  rounded-md  `:  `w-full px-5 hover:border-none mb-8 hover:shadow-lg duration-200 py-4 border-[1px] rounded-md  border-gray-200`}>
